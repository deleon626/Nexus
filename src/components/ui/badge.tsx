 ...
 * Badge Component
 *
 * shadcn/ui-style badge with variants for status display.
 * Status colors: yellow/gray for pending, green for approved, red for rejected.
 */
  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        // Status variants per CONTEXT.md
        pending:
